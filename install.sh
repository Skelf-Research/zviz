...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/Skelf-Research/zviz/main/install.sh | sh
#   curl -fsSL https://raw.githubusercontent.com/Skelf-Research/zviz/main/install.sh | sh -s -- --version 0.1.0
#   curl -fsSL https://raw.githubusercontent.com/Skelf-Research/zviz/main/install.sh | sh -s -- --help
#
# Options:
